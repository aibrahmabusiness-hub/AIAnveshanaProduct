...
exports.SSRFBlockedError = exports.EngineGenericError = exports.FormulaEvaluationError = exports.InvalidCronExpressionError = exports.FetchError = exports.FileSizeError = exports.PausedFlowTimeoutError = exports.FileStoreError = exports.StorageError = exports.StorageInvalidKeyError = exports.StorageLimitError = exports.ConnectionExpiredError = exports.ConnectionLoadingError = exports.ConnectionNotFoundError = exports.ExecutionError = exports.ExecutionErrorType = void 0;
const store_entry_1 = require("../../core/store-entry/store-entry");
...
class FormulaEvaluationError extends ExecutionError {
...
class SSRFBlockedError extends ExecutionError {
    constructor({ host, ip, cause }) {
        super('SSRFBlockedError', formatMessage(`SSRF protection: refusing to connect to ${host} (resolved ${ip}) — private, loopback, link-local, or multicast address`), ExecutionErrorType.USER, cause);
    }
}
