...
export declare const METRIC_TO_LIMIT_MAPPING: {
    readonly "active-flows": "activeFlowsLimit";
};
export declare const METRIC_TO_USAGE_MAPPING: {
    readonly "active-flows": "activeFlows";
};
export declare const UpdateActiveFlowsAddonParamsSchema: z.ZodObject<{
    newActiveFlowsLimit: z.ZodNumber;
}, z.core.$strip>;
export type UpdateActiveFlowsAddonParams = z.infer<typeof UpdateActiveFlowsAddonParamsSchema>;
export declare const CreateCheckoutSessionParamsSchema: z.ZodObject<{
    newActiveFlowsLimit: z.ZodNumber;
}, z.core.$strip>;
export type CreateSubscriptionParams = z.infer<typeof CreateCheckoutSessionParamsSchema>;
export declare const CreateAICreditCheckoutSessionParamsSchema: z.ZodObject<{
    aiCredits: z.ZodNumber;
}, z.core.$strip>;
export type CreateAICreditCheckoutSessionParamsSchema = z.infer<typeof CreateAICreditCheckoutSessionParamsSchema>;
export declare const UpdateAICreditsAutoTopUpParamsSchema: z.ZodUnion<readonly [z.ZodObject<{
    state: z.ZodLiteral<AiCreditsAutoTopUpState.ENABLED>;
    minThreshold: z.ZodNumber;
    creditsToAdd: z.ZodNumber;
    maxMonthlyLimit: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
}, z.core.$strip>, z.ZodObject<{
    state: z.ZodLiteral<AiCreditsAutoTopUpState.DISABLED>;
}, z.core.$strip>]>;
...
export declare const isCloudPlanButNotEnterprise: (plan?: string | null) => boolean;
