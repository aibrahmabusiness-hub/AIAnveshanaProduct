...
exports.isNil = isNil;
exports.stringifyNullOrUndefined = stringifyNullOrUndefined;
...
exports.mapsAreSame = mapsAreSame;
exports.validateIndexBound = validateIndexBound;
exports.isManualPieceTrigger = isManualPieceTrigger;
...
function stringifyNullOrUndefined(data) {
    if (data === undefined) {
        return 'undefined';
    }
    return 'null';
...
function validateIndexBound({ index, limit, }) {
    if (index < 0) {
        return 0;
    }
    if (index >= limit) {
...
function isManualPieceTrigger({ pieceName, triggerName }) {
...
function isBase64(value, options) {
    ...
    if (options === null || options === void 0 ? void 0 : options.allowMime) {
