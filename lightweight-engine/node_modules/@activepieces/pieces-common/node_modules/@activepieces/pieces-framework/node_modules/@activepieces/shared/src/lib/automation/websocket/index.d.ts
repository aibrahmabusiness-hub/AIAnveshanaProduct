...
export declare const BadgeAwarded: z.ZodObject<{
    badge: z.ZodString;
    userId: z.ZodString;
}, z.core.$strip>;
export declare const LockResourceRequest: z.ZodObject<{
    resourceId: z.ZodString;
    force: z.ZodOptional<z.ZodBoolean>;
}, z.core.$strip>;
export declare const LockResourceResponse: z.ZodObject<{
    acquired: z.ZodBoolean;
    lock: z.ZodNullable<z.ZodObject<{
        userId: z.ZodString;
        userDisplayName: z.ZodString;
    }, z.core.$strip>>;
}, z.core.$strip>;
export declare const ResourceLockedEvent: z.ZodObject<{
    resourceId: z.ZodString;
    userId: z.ZodString;
    userDisplayName: z.ZodString;
}, z.core.$strip>;
export declare const ResourceUnlockedEvent: z.ZodObject<{
    resourceId: z.ZodString;
}, z.core.$strip>;
export declare const PresenceRequest: z.ZodObject<{
    resourceId: z.ZodString;
}, z.core.$strip>;
export declare const PresenceUser: z.ZodObject<{
    userId: z.ZodString;
    userDisplayName: z.ZodString;
    userEmail: z.ZodString;
    userImageUrl: z.ZodNullable<z.ZodString>;
}, z.core.$strip>;
export declare const PresenceUpdatedEvent: z.ZodObject<{
    resourceId: z.ZodString;
