...
declare function getStepNumber(trigger: FlowTrigger, stepName: string): number;
...
export declare const flowStructureUtil: {
    ...
    getStepNumber: typeof getStepNumber;
...
export {};
//# sourceMappingURL=flow-structure-util.d.ts.map