import { z } from 'zod';
import { ResumeReason, StreamStepProgress, TriggerHookType } from '../engine';
import { ExecutionType } from '../flow-run/execution/execution-output';
import { RunEnvironment } from '../flow-run/flow-run';
import { FlowTriggerType } from '../flows/triggers/trigger';
export declare const LATEST_JOB_DATA_SCHEMA_VERSION = 10;
...
export declare const BeginExecuteFlowJobData: z.ZodObject<{
    projectId: z.ZodString;
    platformId: z.ZodString;
...
export declare const ResumeExecuteFlowJobData: z.ZodObject<{
    ...
    logsFileId: z.ZodString;
    traceContext: z.ZodOptional<z.ZodRecord<z.ZodString, z.ZodString>>;
    executionType: z.ZodLiteral<ExecutionType.RESUME>;
    resumeReason: z.ZodEnum<typeof ResumeReason>;
}, z.core.$strip>;
export type ResumeExecuteFlowJobData = z.infer<typeof ResumeExecuteFlowJobData>;
export declare const ExecuteFlowJobData: z.ZodDiscriminatedUnion<[z.ZodObject<{
    projectId: z.ZodString;
    platformId: z.ZodString;
    jobType: z.ZodLiteral<WorkerJobType.EXECUTE_FLOW>;
    environment: z.ZodEnum<typeof RunEnvironment>;
...
export declare const ExecuteChatAgentJobData: z.ZodObject<{
    schemaVersion: z.ZodNumber;
    jobType: z.ZodLiteral<WorkerJobType.EXECUTE_CHAT_AGENT>;
...
export declare const EventDestinationJobData: z.ZodObject<{
    ...
    payload: z.ZodUnion<readonly [z.ZodObject<{
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.CONNECTION_DELETED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.CONNECTION_UPSERTED>]>;
        data: z.ZodObject<{
        ...
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.VARIABLE_UPSERTED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.VARIABLE_DELETED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.VARIABLE_VALUE_REVEALED>]>;
        data: z.ZodObject<{
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_CREATED>;
        data: z.ZodObject<{
            flow: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_DELETED>;
        data: z.ZodObject<{
            flow: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_UPDATED>;
        data: z.ZodObject<{
            flow: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_PUBLISHED>;
        data: z.ZodObject<{
            flow: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_ACTIVATED>;
        data: z.ZodObject<{
            flow: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_DEACTIVATED>;
        data: z.ZodObject<{
            flow: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_RUN_STARTED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_RUN_FINISHED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_RUN_RESUMED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FLOW_RUN_RETRIED>]>;
        data: z.ZodObject<{
            flowRun: z.ZodObject<{
                id: z.ZodString;
        ...
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.USER_SIGNED_IN>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.USER_PASSWORD_RESET>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.USER_EMAIL_VERIFIED>]>;
        data: z.ZodObject<{
        ...
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FOLDER_UPDATED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FOLDER_CREATED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.FOLDER_DELETED>]>;
        data: z.ZodObject<{
            folder: z.ZodObject<{
                id: z.ZodString;
                created: z.ZodPipe<z.ZodTransform<unknown, unknown>, z.ZodString>;
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.USER_SIGNED_UP>;
        data: z.ZodObject<{
        ...
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.SIGNING_KEY_CREATED>]>;
        data: z.ZodObject<{
        ...
        action: z.ZodUnion<readonly [z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.PROJECT_ROLE_CREATED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.PROJECT_ROLE_UPDATED>, z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.PROJECT_ROLE_DELETED>]>;
        data: z.ZodObject<{
        ...
        action: z.ZodLiteral<import("../../ee/audit-events").ApplicationEventName.PROJECT_RELEASE_CREATED>;
        data: z.ZodObject<{
            release: z.ZodObject<{
                name: z.ZodString;
