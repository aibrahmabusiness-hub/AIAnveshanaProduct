...
export type FlowRunRetryOutsideRetentionErrorParams = BaseErrorParams<ErrorCode.FLOW_RUN_RETRY_OUTSIDE_RETENTION, {
    flowRunId: FlowRunId;
...
export type TriggerUpdateStatusErrorParams = BaseErrorParams<ErrorCode.TRIGGER_UPDATE_STATUS, {
    flowId?: FlowId;
...
//# sourceMappingURL=activepieces-error.d.ts.map