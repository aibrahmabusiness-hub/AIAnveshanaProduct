...
exports.WebhookRenewConfiguration = zod_1.z.union([
    zod_1.z.object({
        strategy: zod_1.z.literal(WebhookRenewStrategy.CRON),
        cronExpression: zod_1.z.string(),
    }),
    zod_1.z.object({
        strategy: zod_1.z.literal(WebhookRenewStrategy.NONE),
    }),
]);
class ITrigger {
    constructor(name, displayName, description, requireAuth, props, type, handshakeConfiguration, onHandshake, renewConfiguration, onRenew, onEnable, onDisable, onStart, run, test, sampleData, testStrategy, aiMetadata) {
        this.name = name;
...
const createTrigger = (params) => {
    ...
    switch (params.type) {
        ...
        case shared_1.TriggerStrategy.APP_WEBHOOK:
            return new ITrigger(params.name, params.displayName, params.description, (_p = params.requireAuth) !== null && _p !== void 0 ? _p : true, params.props, params.type, { strategy: shared_1.WebhookHandshakeStrategy.NONE }, () => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return ({ status: 200 }); }), { strategy: WebhookRenewStrategy.NONE }, (() => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return Promise.resolve(); })), params.onEnable, params.onDisable, (_q = params.onStart) !== null && _q !== void 0 ? _q : (() => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return Promise.resolve(); })), params.run, (_r = params.test) !== null && _r !== void 0 ? _r : (() => Promise.resolve([params.sampleData])), params.sampleData, ((0, shared_1.isNil)(params.sampleData) && (0, shared_1.isNil)(params.test)) ? shared_1.TriggerTestStrategy.SIMULATION : shared_1.TriggerTestStrategy.TEST_FUNCTION, params.aiMetadata);
    }
};
